...
class AccessCredentialPhonebook(db.Model):
    __tablename__ = "access_credential_phonebooks"

    id = db.Column(db.Integer, primary_key=True)
    credential_id = db.Column(db.Integer, db.ForeignKey("access_credentials.id"), nullable=False)
    phonebook_id = db.Column(db.Integer, db.ForeignKey("phonebooks.id"), nullable=False)
