...
class User(db.Model):
    ...
    ftp_enabled = db.Column(db.Boolean, default=False, nullable=False)
    ftp_username = db.Column(db.String(80), unique=True, nullable=True)
    ftp_password_hash = db.Column(db.String(255), nullable=True)
    created_at = db.Column(db.DateTime, default=datetime.utcnow, nullable=False)
    ...
    def set_ftp_password(self, password: str) -> None:
        self.ftp_password_hash = generate_password_hash(password)